...
$title = "Lawyers Website | Lawyers | Create New Password";
$role = "Lawyer";
require("includes/header.inc.php");
if(isset($_POST["forgot"])){
    $password = $_POST['password'];
	mysqli_query($conn,"update user set password='".$password."' where email='".$_SESSION['email']."' and status='1'");
?>
		...
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" action="" method="POST" onsubmit="return formValidation()">
					...
					<div class="wrap-input100 validate-input" style="margin-top:20px !important;margin-bottom:0px !important;" data-validate="New Password is required">
					...
					<div class="container-login100-form-btn" style="margin-top:10px !important;">
                        <input type="submit" value="Reset Password" name="forgot" class="login100-form-btn" style="background-color:#b89b5e ;">
					</div>

					<div class="text-center p-t-12">
						<a class="txt2" href="login.php">
                            Login to Lawyers Account
						</a>
					</div>
