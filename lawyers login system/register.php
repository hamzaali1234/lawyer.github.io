...
$title = "Lawyers Website | Lawyers | Register";
$role = "Lawyer";
...
<script type="text/javascript">
    alert("Lawyer Account already Exist");
</script>
<?php
	} else {
		mysqli_query($conn,"insert into user (username,email,password,role,status) values ('$username', '$email', '$password','$role','1')");
		mysqli_query($conn,"insert into lawyer_details (user_id) values ('$id')");
?>
<script type="text/javascript">
    alert("A Lawyer account has been created Successfully!!!");
</script>
<?php
