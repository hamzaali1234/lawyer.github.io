...
$title = "Lawyers Website | Lawyers | Login";
$role = "Lawyer";
...
<script type="text/javascript">
	alert("Sorry! You can't login to this Lawyer Account because Your Account has been Blocked by Admin!!!");
</script>
<?php
			}else{
...
?>
<script type="text/javascript">
	alert("Please! Login to Lawyer Account OR Enter Correct Username & Password");
</script>
<?php
	}	
}
