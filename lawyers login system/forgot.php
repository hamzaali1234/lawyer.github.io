...
$title = "Lawyers Website | Lawyers | Forgot Password";
$role = "Lawyer";
require("includes/header.inc.php");
if(isset($_POST["forgot"])){
    $email = $_POST['email'];
	$query= mysqli_query($conn,"select * from user where email='".$email."' and role='".$role."' and status='1'");
			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" action="" method="POST" onsubmit="return formValidation()">
					...
					<div class="container-login100-form-btn" style="margin-top:10px !important;">
                        <input type="submit" value="Forgot" name="forgot" class="login100-form-btn" style="background-color:#b89b5e ;">
					</div>
