...
$title = "Lawyers Website - Admin Login";
$role = "Admin";
...
<script type="text/javascript">
	alert("Please! Login to Admin Account OR Enter Correct Username & Password");
</script>
<?php
	}
}
			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" action="" method="POST" onsubmit="return formValidation()">
					...
					<div class="container-login100-form-btn" style="margin-top:10px !important;">
                        <input type="submit" value="Login" name="login" style="background-color:#b89b5e ;color:white;" class="login100-form-btn">
					</div>
